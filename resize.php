...
if( !$image = $_POST["img"] ){
    ...
    if( !$info ){
        ...
        $thumbImg01 = imagecreatetruecolor(600,600); /*设置最大的切图尺寸*/
        imagecopyresampled($thumbImg01,$thumbImg,0,0,$x,$y,600,600,$w,$h);
       ...
       // imagecopyresampled($thumbImg03,$thumbImg,0,0,$x,$y,312,312,$w,$h);
